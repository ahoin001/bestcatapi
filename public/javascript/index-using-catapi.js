...
// ****************************************************************
//? CAT API Utility FUNCTIONS
// ****************************************************************

const setRandomCat = async () => {

    // Uses CatApi
    const catApiResponse = await fetchCatApi();
    console.log("***FROM MAIN CATAPI: ", catApiResponse)

    randomCatPic.setAttribute("src", catApiResponse[0].url)

    catImageID = catApiResponse[0].id;
